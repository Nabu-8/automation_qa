...
# Залежить від того як робиться UI у вас: Якщо елементи стабільні(тобто нема постійних змін типу кути прямі/косі, колір трохи не
# такий і тд) - то краще вказувати всі класи. Якщо візуал елементів постійно міняеться, то варто прив'язуватись до якось стабільного
# класу чи просити девів додавати якісь стабільші атрибути(наприклад test-id)
...
# Доречі, якщо у вас одна мова, то достатньо шукати по тексту, а якщо мова сайту може бути ріщна, то треба або не прив'язуватись
# до тексту або обхоити іншим чином)
